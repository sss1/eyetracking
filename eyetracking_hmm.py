...
def getMLE():
  ...
  X = X[0:100, :] # TODO: REMOVE THIS; JUST USED TO AVOID NANS FOR DEBUGGING!
  ...
  eyetrack_len = X.shape[trial_idx]
  num_distractors = len(distractors_xy_list[trial_idx])
  ...
  trans_prob = 0.01 # Probability of transitioning between any pair of states
  n_states = num_distractors + 1
