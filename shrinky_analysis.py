...
# ages_shrinky = np.asarray([age for (age,subject_data) in zip(ages_shrinky, data_shrinky) if subject_data[0] is not None])
...
#          ages_shrinky = ages_shrinky, \
#          ages_noshrinky = ages_noshrinky, \
